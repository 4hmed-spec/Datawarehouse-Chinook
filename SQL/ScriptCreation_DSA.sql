...
/*******************************************************************************
   DSA Database - Version 1.4.5
   Script: DSA_Oracle.sql
   Description: Creates and populates the DSA database.
   DB Server: Oracle
   Author: Luis Rocha
   License: https://github.com/lerocha/DSA-database/blob/master/LICENSE.md
********************************************************************************/
...
GRANT connect to c##DSA;
GRANT resource to c##DSA;
GRANT create session TO c##DSA;
GRANT create table TO c##DSA;
GRANT create view TO c##DSA;
